...
namespace WebApplication8.Controllers
{
    public class OgrenciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OgrID,OgrAd,OgrSoyad,OgrAdres")] Ogrenci ogrenci)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OgrID,OgrAd,OgrSoyad,OgrAdres")] Ogrenci ogrenci)
        {
            if (ModelState.IsValid)
            {
